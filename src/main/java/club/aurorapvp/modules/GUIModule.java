...
public class GUIModule {
  ...
  public static void initializeGUI() {
    ...
    if (GUIData.getConfigurationSection("kits") != null) {
      for (Object path : GUIData.getConfigurationSection("kits").getKeys(false).toArray()) {
        inv.addItem(createGUIItem(GUIData.getItemStack("kits." + path + ".displayItem").getType(),
            (String) path, GUIData.getString("kits." + path + ".creator"),
            GUIData.getInt("kits." + path + ".type")));
      }
    }
  }
